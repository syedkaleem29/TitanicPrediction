...
# Training the model
np.random.seed(5)
parameters = nnutil.nn_model(X_train, Y_train, layers_dim, lambd=0.03, print_cost=True)
predictions = nnutil.predict(X_train, parameters)
nnutil.eval_model(Y_train, predictions)
# Prediction and file creation
